...
// BFF.cpp : Defines the class behaviors for the application.
//
...
// The one and only CBFFApp object

CBFFApp theApp;


// CBFFApp initialization

BOOL CBFFApp::InitInstance()
{
